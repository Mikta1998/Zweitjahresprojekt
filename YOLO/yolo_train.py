...
def train_yolo(yolo_path: str, data_path: str, epochs: int = 10, patience: int = 10):
    ...
    for epoch in range(epochs):
        # Training step
        model.train(data=data_path, epochs=10, plots=False)
        
        # Validation step (assuming val data is in 'val' subfolder)
        metrics = metrics = predicition_yolo(yolo_path, 'dataset/split/val')
...
def main(data_path_predict, save_results=False, results_path='None', train=False, data_path_train='None', epochs=100, patience=10):
    ...
    YOLO_PATH = 'models/yolov8m-cls.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='dataset/split/val')
    parser.add_argument('--save_results', type=bool, default=False)
    parser.add_argument('--results_path', type=str, default='./results')

    # parser arguments for training
    parser.add_argument('--train', type=bool, default=True)
    parser.add_argument('--data_path', type=str, default='dataset/split/train_balanced')
