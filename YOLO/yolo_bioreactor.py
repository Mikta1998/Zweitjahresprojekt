...
def train_yolo(yolo_path: str, data_path: str, epochs: int = 10):
...
def main(data_path_predict, save_results=False, results_path='None', train=False, data_path_train='None', epochs=70):
    ...
    YOLO_PATH = 'YOLO/models/yolov8m-cls.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='dataset/split/train')
